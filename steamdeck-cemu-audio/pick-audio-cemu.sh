...
## steam launch option example: "sh" "/home/deck/pick-audio-cemu.sh" && "run" "--branch=stable" "--arch=x86_64" "--command=/app/bin/Cemu-wrapper" "info.cemu.Cemu" -f -g "/path/to/game/file"
