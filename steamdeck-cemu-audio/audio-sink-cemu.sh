...
## steam launch option example: /bin/bash -c '/home/deck/audio-sink-cemu.sh && /usr/bin/flatpak "run" "--branch=stable" "--arch=x86_64" "--command=/app/bin/Cemu-wrapper" "info.cemu.Cemu" -f -g "/path/to/game/file"'
